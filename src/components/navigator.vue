<template>
  <div style="background-color: rgb(15,15,15) ;width: 100%;height: 80px;position: fixed;z-index: 999999999;">
    <div id="nevigator-bottom">
      <div id="icon" style="background-color:;width:30%;height:50px;margin-left: 1%;float: left;position: relative"><router-link to="/">
      ...
      <div style="position: relative;float:left;width: 50%;padding-top:18px;margin-left: 5%"id="note">
        <el-menu  style="background-color: transparent" mode="horizontal" >
          ...
          <el-menu-item style="background-color: transparent;color: aliceblue;font-family:'Lucida Grande';font-size: 1.5em;margin-left:10%" index="2"><a href="#rank-line">排行榜</a></el-menu-item>
        </el-menu>
